            ...
            <div className="container non-home-page">
                ...
                <div className="services-info">
                    ...
                    <div className="services-info__description">
                        <p>Нередко разборка крупногабаритных объектов является проблематичной как для предприятий, так и для физических лиц. <strong>Демонтаж металлолома</strong> является еще одним направлением деятельности ООО «КомпанияАлимет».</p>
                        <p>Те, кто уже столкнулся с проблемами демонтажа, понимают, что этот процесс требует ответственного подхода, наличия специальной техники и инструмента, а также квалифицированных рабочих. ООО «КомпанияАлимет» обладает всеми этими составляющими.</p>
