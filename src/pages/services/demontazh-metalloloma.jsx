            ...
            <div className="container non-home-page">
                ...
                <div className="services-info">
                    ...
                    <div className="services-info__description">
                        <p>Нередко разборка крупногабаритных объектов является проблематичной как для предприятий, так и для физических лиц. <strong>Демонтаж металлолома</strong> является еще одним направлением деятельности ООО «Компания Алимет».</p>
                        <p>Те, кто уже столкнулся с проблемами демонтажа, понимают, что этот процесс требует ответственного подхода, наличия специальной техники и инструмента, а также квалифицированных рабочих. ООО «Компания Алимет» обладает всеми этими составляющими.</p>
                        <p>Организация работ на каждом объекте <strong>в Екатеринбурге</strong> и на территории <strong>Свердловской области</strong> происходит после анализа всех особенностей, в том числе сложности разборки и необходимости сохранить соседние конструкции.</p>
