            ...
            <div className="container non-home-page">
                ...
                <div className="services-info">
                    ...
                    <div className="services-info__description">
                        ...
                        <p>Важным принципом является чистота металла, ведь именно от нее зависит <strong>цена за металлолом</strong> в Екатеринбурге. Самыми дорогими считаются предметы из сплава меди и латуни, чуть меньшую прибыль можно получить от продажи алюминия.</p>
