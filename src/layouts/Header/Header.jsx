        ...
        <header className="header" data-js-overlay-menu="">
            <div className="header__contacts">
                <div className="container">
                    <div className="hidden-mobile header__city">Екатеринбург, Шефская улица, 115</div>
                    <div className="header__tel"><a href="tel:%2B7%28901%29856‒33‒42">+7 (901) 856‒33‒42</a></div>
